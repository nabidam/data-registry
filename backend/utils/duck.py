...
def parquet_source(uris: Sequence[str]) -> str:
    ...
    if not uris:
        ...
        return (
            ...
            "NULL::DOUBLE AS quality, NULL::VARCHAR AS document_id, "
            "NULL::INTEGER AS n_tokens, NULL::VARCHAR AS length_bucket, "
            "NULL::BOOLEAN AS has_math, NULL::BOOLEAN AS has_numbers_units, "
            "NULL::BOOLEAN AS has_acronyms, NULL::BOOLEAN AS has_mixed_script, "
            "NULL::DOUBLE AS rare_term_score, NULL::BOOLEAN AS is_rare_term, "
            "NULL::VARCHAR AS evaluation_split, NULL::BOOLEAN AS human_verify, "
